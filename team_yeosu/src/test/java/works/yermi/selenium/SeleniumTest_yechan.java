...
@Log4j
public class SeleniumTest_yechan {
	
	private final String WEB_DRIVER_ID = "webdriver.chrome.driver"; 
	private final String WEB_DRIVER_PATH = "C:\\devtools\\selenium\\chromedriver.exe";
	private String url = "http://project.yermi.works/member/mypage/listReservation"; 
	private WebDriver driver;

	public SeleniumTest_yechan() {
	...
	public void crawl() throws InterruptedException {
		...
		driver.findElement(By.id("username")).sendKeys("yermi");
		driver.findElement(By.id("password")).sendKeys("Yermi1234!");

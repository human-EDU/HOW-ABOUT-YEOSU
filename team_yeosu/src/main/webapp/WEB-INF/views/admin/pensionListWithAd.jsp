			...
			<jsp:include page="../common/admin_nav.jsp"/>
               	...
               	<sec:authorize access="hasRole('ROLE_ADMIN')">
	                ...
	                <div class="container-fluid">
						<%-- ${members} --%>
	                    <!-- Page Heading -->
	                    <h1 class="h3 mb-2 text-gray-800">광고 승인 업체 목록</h1>
	                    <!-- DataTales Example -->
	                        	...
	                        	<ul class="list-group">
									...
									<li class="list-group-item" >
										<form method="post">
											...
											<button type="submit" name="modifyBtn" class="btn btn-primary btn-modify float-right">광고 취소</button>
											<sec:csrfInput/>
										</form> 
									</li>
									</c:forEach>
	                    ...
	                    <ul class="pagination justify-content-center">
							<c:if test="${page.prev}">
								<li class="page-item"><a class="page-link" href="pensionListWithAd${page.cri.paramWithoutPageNum}&pageNum=${page.start-1}">prev</a></li>
							</c:if>
							<c:forEach begin="${page.start}" end="${page.end}" var="p">
								<li class="page-item ${page.cri.pageNum == p ? 'active' : ''}"><a class="page-link" href="pensionListWithAd${page.cri.paramWithoutPageNum}&pageNum=${p}">${p}</a></li>
							</c:forEach>
							<c:if test="${page.next}">
								<li class="page-item"><a class="page-link" href="pensionListWithAd${page.cri.paramWithoutPageNum}&pageNum=${page.end+1}">next</a></li>
							</c:if>
						</ul>
	                </div>
                </sec:authorize>
